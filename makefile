...
bin/Limb.o: src/game/Limb.cpp src/game/Limb.h  
	g++ -std=c++11 -c src/game/Limb.cpp -I /include/SDL2 -L /lib -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -lpthread -fpermissive -O3 -o bin/Limb.o

bin/LootTable.o: src/game/LootTable.cpp src/game/LootTable.h  
	g++ -std=c++11 -c src/game/LootTable.cpp -I /include/SDL2 -L /lib -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -lpthread -fpermissive -O3 -o bin/LootTable.o
...
bin/Squad.o: src/game/Squad.cpp src/game/Squad.h  src/game/Character.h src/game/Character.cpp  
	g++ -std=c++11 -c src/game/Squad.cpp -I /include/SDL2 -L /lib -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -lpthread -fpermissive -O3 -o bin/Squad.o
