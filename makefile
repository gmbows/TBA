TBA.exe: bin/Font.o bin/Screen.o bin/ScreenUtils.o bin/Window.o bin/Log.o bin/Utility.o bin/Clock.o bin/Common.o bin/Game.o bin/KeyFuncs.o bin/Keys.o bin/Tile.o bin/Behavior.o bin/Block.o bin/Character.o bin/Command.o bin/CommandFuncs.o bin/CommandUtils.o bin/Container.o bin/Equipment.o bin/FloatingText.o bin/GameObject.o bin/Input.o bin/Inventory.o bin/Item.o bin/ItemManifest.o bin/Limb.o bin/Projectile.o bin/Statistics.o bin/Structure.o bin/World.o bin/Main.o
