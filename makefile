...
bin/Screen.o: src/ui/Screen.cpp src/ui/Screen.h 
	g++ -std=c++11 -c src/ui/Screen.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/Screen.o

bin/Window.o: src/ui/Window.cpp src/ui/Window.h 
	g++ -std=c++11 -c src/ui/Window.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/Window.o

bin/ScreenUtils.o: src/ui/ScreenUtils.cpp  
	g++ -std=c++11 -c src/ui/ScreenUtils.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/ScreenUtils.o
...
bin/Keys.o: src/common/Keys.cpp  
	g++ -std=c++11 -c src/common/Keys.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/Keys.o

bin/Common.o: src/common/Common.cpp src/common/Common.h 
	g++ -std=c++11 -c src/common/Common.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/Common.o
...
bin/Input.o: src/game/Input.cpp src/game/Input.h 
	g++ -std=c++11 -c src/game/Input.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/Input.o

bin/Statistics.o: src/game/Statistics.cpp src/game/Statistics.h 
	g++ -std=c++11 -c src/game/Statistics.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/Statistics.o

bin/Command.o: src/game/Command.cpp src/game/Command.h 
	g++ -std=c++11 -c src/game/Command.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/Command.o

bin/Block.o: src/game/Block.cpp src/game/Block.h 
	g++ -std=c++11 -c src/game/Block.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/Block.o

bin/Item.o: src/game/Item.cpp src/game/Item.h 
	g++ -std=c++11 -c src/game/Item.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/Item.o

bin/Container.o: src/game/Container.cpp src/game/Container.h 
	g++ -std=c++11 -c src/game/Container.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/Container.o

bin/GameObject.o: src/game/GameObject.cpp src/game/GameObject.h 
	g++ -std=c++11 -c src/game/GameObject.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/GameObject.o

bin/World.o: src/game/World.cpp src/game/World.h 
	g++ -std=c++11 -c src/game/World.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/World.o

bin/FloatingText.o: src/game/FloatingText.cpp src/game/FloatingText.h 
	g++ -std=c++11 -c src/game/FloatingText.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/FloatingText.o

bin/Projectile.o: src/game/Projectile.cpp src/game/Projectile.h 
	g++ -std=c++11 -c src/game/Projectile.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/Projectile.o

bin/Behavior.o: src/game/Behavior.cpp src/game/Behavior.h 
	g++ -std=c++11 -c src/game/Behavior.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/Behavior.o

bin/Inventory.o: src/game/Inventory.cpp src/game/Inventory.h 
	g++ -std=c++11 -c src/game/Inventory.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/Inventory.o

bin/ItemManifest.o: src/game/ItemManifest.cpp src/game/ItemManifest.h 
	g++ -std=c++11 -c src/game/ItemManifest.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/ItemManifest.o

bin/Character.o: src/game/Character.cpp src/game/Character.h 
	g++ -std=c++11 -c src/game/Character.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/Character.o

bin/Equipment.o: src/game/Equipment.cpp src/game/Equipment.h 
	g++ -std=c++11 -c src/game/Equipment.cpp `sdl2-config --libs --cflags` -lSDL2main -lSDL2_image -O2 -o bin/Equipment.o
